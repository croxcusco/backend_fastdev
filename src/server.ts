...
async function startApolloServer() {
    ...
    const allowedOrigins = ['https://crox.up.railway.app', 'http://localhost:5173', 'https://croxcusco.org.pe/','http://localhost:4321', 'https://croxcusco.up.railway.app']; // Agrega más orígenes aquí
